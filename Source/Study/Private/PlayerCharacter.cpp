...
void APlayerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	InputComponent->BindAction(TEXT("Fire"), IE_Pressed, this, &APlayerCharacter::BeginFire);
	InputComponent->BindAction(TEXT("Fire"), IE_Released, this, &APlayerCharacter::EndFire);
}

void APlayerCharacter::BeginFire()
{
	bIsDownFireButton = true;
}

void APlayerCharacter::EndFire()
{
	bIsDownFireButton = false;
}
